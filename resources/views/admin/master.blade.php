    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a class="brand-link" href="/">
                ...
                <span class="brand-text font-weight-light ml-3">CHEESEWORKS</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" data-accordion="false" role="menu">
                        ...
                        <li class="nav-item  @if (Request::path() == '/') menu-open @endif">
                        ...
                        <li class="nav-item @if (Request::is('manage/employee/*') || Request::is('manage/employee')) menu-open @endif">
                            <a class="nav-link " href="/admin/manage/employee">
                        ...
                        <li class="nav-item @if (Request::is('manage/fwa-request/*') || Request::is('manage/fwa-request')) menu-open @endif">
                            <a class="nav-link " href="/admin/manage/fwa-request">
